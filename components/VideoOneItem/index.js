 ...
 * @LastEditTime: 2021-03-02 08:17:36
  ...
  methods: {
    ...
    ended() {
      try {
        ...
        this.showVideo = false;
        this.player.poster = this.list[this.current].file.cover;
        this.player.src = this.list[this.current].file.m3u8url;
      } catch (error) {
        console.error(error);
      }
    },
