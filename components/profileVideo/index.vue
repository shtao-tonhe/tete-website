<!--
 * @Author: your name
 * @Date: 2020-10-24 15:53:18
 * @LastEditTime: 2021-01-30 16:33:15
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /az-pc/components/profileVideo/index.vue
-->
<template>
  <div
    ...
    class="jsx-2261688415 video-feed-item video-feed-item-box"
  >
    <div class="jsx-2261688415 _ratio_">
      <div class="jsx-2261688415" style="padding-top: 132.653%">
        <div class="jsx-2261688415 _ratio_wrapper">
          <a class="jsx-256221443 video-feed-item-wrapper"
            ><div
              ...
              "
            >
              <div class="jsx-1778455663 video-card default">
                <div
                  class="m3u8Video profile-box"
                  :class="['mse' + index, isHorizontal ? 'horizontal' : '']"
                  v-show="index == currentIndex && showVideo"
                ></div>
                <videoLoading v-if="showLoading"></videoLoading>
                <div class="jsx-1778455663 video-card-mask">
                  <div class="jsx-1036923518 card-footer normal no-avatar">
                    <div class="jsx-1036923518 video-bottom-info">
                      <svg
                        class="like-icon"
                        width="18"
                        height="18"
                      ...
                      >
                        ...
                        ></path></svg
                      ><strong class="jsx-1036923518 video-count">
                        {{ (item && item.point_praise_num) || 0 | Formats }}
                      </strong>
                    </div>
                  </div>
                </div>
