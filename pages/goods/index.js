 ...
 * @LastEditTime: 2021-03-02 17:53:34
...
export default {
  ...
  methods: {
    ...
    front_order_create() {
      ...
      this.$confirm({
        title: `You will spend ${this.selectOne.integral}TB to buy this product`,
        onOk: async () => {
          this.loadingBuy = true;
          let res = await this.$api
            .front_order_create({
              goods_id: this.selectOne.id
            })
            .catch(err => {
    ...
    async front_goods_getlist() {
      ...
      let arr = [
        {
          searchValue: this.$route.query.userId,
